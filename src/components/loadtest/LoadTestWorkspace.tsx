        ...
        <div className="wb-panel mt-3 p-3">
          <div className="flex flex-wrap items-start justify-between gap-3 border-b border-border-default/70 pb-3">
            <div>
              ...
              <div className="mt-1 text-[11px] text-text-tertiary">{t('loadtest.configDesc')}</div>
            </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {durationMode === "duration" ? (
                  <>
                    ...
                    <span className="text-[11px] text-text-tertiary">{t('loadtest.seconds')}</span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="text-[11px] text-text-tertiary">{t('loadtest.requests')}</span>
                  </>
                )}
              </div>
            </ControlBlock>
            ...
            <ControlBlock label={t('loadtest.rateLimit')} icon={<Gauge className="h-3 w-3" />}>
              <div className="space-y-2">
                ...
                {rpsEnabled ? (
                  ...
                  <div className="text-[11px] text-text-disabled">{t('loadtest.noRateLimitDesc')}</div>
                )}
              </div>
            </ControlBlock>
          </div>
                ...
                <AdvancedSection title={t('loadtest.bodyTitle')}>
                  ...
                  {bodyMode !== "none" ? (
                    <textarea
                      ...
                      rows={8}
                      className="w-full resize-y rounded-[10px] border border-border-default bg-bg-input px-3 py-2 text-[12px] font-mono outline-none focus:border-rose-500 disabled:opacity-60"
                    />
                  ) : (
                    <div className="flex min-h-[178px] items-center justify-center rounded-[10px] border border-dashed border-border-default/80 bg-bg-secondary/20 px-4 text-center text-[11px] text-text-disabled">
      ...
      <div className="min-h-[360px] flex-1 pt-3">
          ...
          <div className="wb-panel mb-3 overflow-hidden panel">
            <div className="flex items-center gap-1 px-4 py-2.5 bg-bg-secondary/32 border-b border-border-default">
              ...
              <button
                ...
                className={cn(
                  "relative px-3 py-1 text-[12px] font-medium transition-colors",
        ...
        {!running && !summary && snapshots.length === 0 && !error && (
          <div className="wb-panel flex flex-col items-center justify-center px-6 py-16 text-text-disabled">
            ...
            <p className="text-[16px] font-semibold text-text-secondary">{t('loadtest.emptyTitle')}</p>
            <p className="text-[13px] mt-1.5 text-text-tertiary">{t('loadtest.emptyDesc')}</p>
            <div className="mt-6 grid w-full max-w-3xl gap-4 text-left sm:grid-cols-3">
              <div className="border-t border-border-default/70 pt-3">
                ...
                <div className="mt-1 text-[10px] text-text-tertiary">{t('loadtest.emptyTargetDesc')}</div>
              </div>
              <div className="border-t border-border-default/70 pt-3">
                <div className="flex items-center gap-2 text-[11px] font-semibold text-text-secondary">
                ...
                <div className="mt-1 text-[10px] text-text-tertiary">{t('loadtest.emptyConcurrencyDesc')}</div>
              </div>
              <div className="border-t border-border-default/70 pt-3">
                <div className="flex items-center gap-2 text-[11px] font-semibold text-text-secondary">
                ...
                <div className="mt-1 text-[10px] text-text-tertiary">{t('loadtest.emptyResultDesc')}</div>
              </div>
            </div>
          </div>
        )}
  ...
  return (
    <div className="wb-panel overflow-hidden panel">
      <div className="flex items-center gap-2 border-b border-border-default bg-bg-secondary/32 px-4 py-2.5">
        ...
        <span className="text-[13px] font-medium text-text-secondary">{t('loadtest.statusCodeDist')}</span>
        <span className="text-[11px] text-text-disabled ml-auto">{t('loadtest.totalRequestsLabel', { count: total })}</span>
      </div>
