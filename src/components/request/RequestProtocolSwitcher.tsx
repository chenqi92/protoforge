...
const options: Array<{
  ...
  { kind: "http", label: "HTTP", icon: FileText, activeClass: "text-method-get", iconBgClass: "bg-method-get/12", description: "REST Request" },
  { kind: "graphql", label: "GraphQL", icon: Braces, activeClass: "text-method-delete", iconBgClass: "bg-method-delete/12", description: "Schema Query" },
  { kind: "ws", label: "WebSocket", icon: Zap, activeClass: "text-method-put", iconBgClass: "bg-method-put/12", description: "Live Connection" },
  { kind: "mqtt", label: "MQTT", icon: Radio, activeClass: "text-method-patch", iconBgClass: "bg-method-patch/12", description: "Message Broker" },
  { kind: "grpc", label: "gRPC", icon: Network, activeClass: "text-method-head", iconBgClass: "bg-method-head/12", description: "RPC Framework" },
];
