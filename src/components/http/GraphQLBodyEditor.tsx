    ...
    <div className="flex h-full min-h-0 flex-col gap-3">
      ...
      {endpointUrl && (
        <div className="flex items-center gap-2 shrink-0 px-1">
          ...
          {schema && (
            <>
              <span className="pf-text-xxs text-success flex items-center gap-1">
          ...
          {schemaError && (
            <span className="pf-text-xxs text-error flex items-center gap-1 truncate max-w-[300px]" title={schemaError}>
