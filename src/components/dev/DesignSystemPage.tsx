...
function Swatch({ label, cssVar, className }: { label: string; cssVar: string; className?: string }) {
  return (
    <div className="flex items-center gap-2">
      <div className={cn("h-8 w-8 pf-rounded-sm border border-border-default/60 shadow-xs", className)}
        style={{ background: `var(${cssVar})` }} />
      <div>
        <div className="pf-text-xs font-medium text-text-primary">{label}</div>
        <div className="pf-text-xxs font-mono text-text-tertiary">{cssVar}</div>
      </div>
    </div>
  );
}
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="space-y-3">
      <h2 className="pf-text-lg font-bold text-text-primary border-b border-border-default/60 pb-2">{title}</h2>
      {children}
    </div>
  );
}
...
export function DesignSystemPage() {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-8 bg-bg-app">
      <div>
        <h1 className="pf-text-4xl font-bold text-text-primary">ProtoForge Design System</h1>
        <p className="pf-text-sm text-text-secondary mt-1">Token reference, component showcase, and usage guide</p>
      </div>
      ...
      <Section title="Colors">
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-3">
            <h3 className="pf-text-sm font-semibold text-text-secondary uppercase tracking-wide">Backgrounds</h3>
          ...
          <div className="space-y-3">
            <h3 className="pf-text-sm font-semibold text-text-secondary uppercase tracking-wide">Text</h3>
            <div className="space-y-2">
            ...
            <h3 className="pf-text-sm font-semibold text-text-secondary uppercase tracking-wide mt-4">Accent</h3>
            <div className="space-y-2">
        ...
        <div className="mt-4 space-y-3">
          <h3 className="pf-text-sm font-semibold text-text-secondary uppercase tracking-wide">Semantic</h3>
        ...
        <div className="mt-4 space-y-3">
          <h3 className="pf-text-sm font-semibold text-text-secondary uppercase tracking-wide">Borders</h3>
          <div className="flex gap-4">
      ...
      <Section title="Typography Scale">
        <div className="space-y-1 pf-rounded-md border border-border-default/60 bg-bg-primary p-4">
          {[
            ...
            <div key={token} className="flex items-baseline gap-4 py-1">
              <span className="w-12 pf-text-xxs font-mono text-text-disabled shrink-0">{label}</span>
              <span style={{ fontSize: `var(${token})` }} className="text-text-primary font-medium">The quick brown fox — {desc}</span>
              <span className="pf-text-3xs font-mono text-text-disabled ml-auto">{token}</span>
            </div>
          ))}
        </div>
      </Section>
        ...
        <div className="flex gap-4 items-end">
          {[
            ...
            <div key={token} className="text-center space-y-1">
              ...
              <div className="pf-text-xxs font-mono text-text-tertiary">{label}</div>
            </div>
          ))}
        </div>
      </Section>
      ...
      <Section title="Buttons">
        <div className="space-y-4">
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Action Buttons (.btn-action)</h3>
          ...
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Sizes</h3>
          ...
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Workbench Buttons (.wb-*)</h3>
            <div className="flex items-center gap-3">
      ...
      <Section title="Segmented Controls">
        <div className="space-y-4 max-w-lg">
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Standard (md)</h3>
            <SegmentedControl
              options={[
                { value: "tcp", label: "TCP" },
                { value: "udp", label: "UDP" },
          ...
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Multi-option</h3>
            <SegmentedControl
              options={[
          ...
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Small (sm)</h3>
            <SegmentedControl
              options={[
                { value: "all", label: "All" },
          ...
          <div>
            <h3 className="pf-text-xs font-semibold text-text-disabled uppercase tracking-wide mb-2">Disabled</h3>
            <SegmentedControl
              options={[
      ...
      <Section title="Input Fields">
        <div className="space-y-3 max-w-md">
          <div>
            <label className="pf-text-xxs font-semibold uppercase tracking-[0.06em] text-text-disabled mb-1 block">Standard (.wb-field)</label>
            <input className="wb-field w-full" value={inputVal} onChange={(e) => setInputVal(e.target.value)} />
          </div>
          <div>
            <label className="pf-text-xxs font-semibold uppercase tracking-[0.06em] text-text-disabled mb-1 block">Small (.wb-field-sm)</label>
            <input className="wb-field-sm w-full" placeholder="Placeholder text..." />
          </div>
          <div>
            <label className="pf-text-xxs font-semibold uppercase tracking-[0.06em] text-text-disabled mb-1 block">Extra Small (.wb-field-xs)</label>
            <input className="wb-field-xs w-full" placeholder="Compact input" />
          </div>
          <div>
            <label className="pf-text-xxs font-semibold uppercase tracking-[0.06em] text-text-disabled mb-1 block">Disabled</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="wb-panel">
            <div className="wb-panel-header flex items-center">
              <span className="pf-text-sm font-semibold text-text-primary">.wb-panel</span>
            </div>
            <div className="p-3 pf-text-xs text-text-secondary">
              Primary panel with header. Used for main content areas.
            </div>
          </div>
          <div className="wb-subpanel">
            <div className="p-3 space-y-2">
              <span className="pf-text-sm font-semibold text-text-primary">.wb-subpanel</span>
              <p className="pf-text-xs text-text-secondary">
        ...
        <div className="flex items-end gap-6">
          {[
            ...
            <div key={size} className="text-center space-y-1">
              ...
              <div className="pf-text-3xs font-mono text-text-disabled">{label}</div>
            </div>
          ))}
        </div>
      </Section>
        ...
        <div className="flex gap-6 flex-wrap">
          {["shadow-xs", "shadow-sm", "shadow-md", "shadow-lg", "shadow-soft"].map((s) => (
            <div key={s} className="text-center space-y-2">
              <div className={cn("h-16 w-24 pf-rounded-md bg-bg-primary border border-border-default/30")}
                style={{ boxShadow: `var(--${s})` }} />
              <div className="pf-text-xxs font-mono text-text-tertiary">{s}</div>
            </div>
          ))}
        </div>
      </Section>
      ...
      <Section title="Spacing Reference">
        <div className="space-y-1 pf-text-xs text-text-secondary">
      ...
      <Section title="Label Patterns">
        <div className="space-y-4 max-w-md">
          <div>
            <label className="pf-text-xxs font-semibold uppercase tracking-[0.06em] text-text-disabled">Settings Label (primary pattern)</label>
            <p className="pf-text-3xs text-text-disabled mt-0.5">font-size: --fs-xxs | weight: 600 | uppercase | tracking: 0.06em | color: text-disabled</p>
          </div>
          <div>
            <label className="pf-text-xs font-medium text-text-secondary">Form Label (secondary pattern)</label>
            <p className="pf-text-3xs text-text-disabled mt-0.5">font-size: --fs-xs | weight: 500 | color: text-secondary</p>
          </div>
        </div>
      </Section>
      ...
      <Section title="Forbidden Patterns">
        <div className="pf-rounded-md border border-error/30 bg-error/5 p-4 space-y-2 pf-text-xs">
          ...
          <ul className="space-y-1 text-text-secondary pl-6 list-disc">
            ...
            <li><code className="font-mono">text-xs / text-sm / text-lg</code> — Use <code className="font-mono text-accent">pf-text-xs</code> etc.</li>
            <li><code className="font-mono">rounded-[8px]</code> — Use <code className="font-mono text-accent">pf-rounded-sm</code></li>
