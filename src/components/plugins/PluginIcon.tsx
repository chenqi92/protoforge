...
export function PluginIcon({ pluginId, fallbackEmoji, className, size = "md" }: PluginIconProps) {
  ...
  return (
    <div className={cn(
      "flex shrink-0 items-center justify-center border border-border-default/80 bg-bg-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] dark:bg-bg-tertiary/40 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
      sizeClasses[size],
      className
    )}>
      {renderContent()}
