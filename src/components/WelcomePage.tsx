...
import { Send, Zap, Network, Radio, Eye, Puzzle, Waves, Braces, ArrowRight, Sparkles, Server, Database } from "lucide-react";
import { useTranslation } from "react-i18next";
import { cn } from "@/lib/utils";

export type WelcomeAction = "http" | "graphql" | "ws" | "sse" | "mqtt" | "tcpudp" | "loadtest" | "capture" | "mockserver" | "dbclient" | "plugins";
